...
public class PascalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PascalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRepetitive_statementAccess().getAlternatives(), "rule__Repetitive_statement__Alternatives");
			builder.put(grammarAccess.getFor_statementAccess().getAlternatives_2(), "rule__For_statement__Alternatives_2");
			builder.put(grammarAccess.getConditional_statementAccess().getAlternatives(), "rule__Conditional_statement__Alternatives");
			...
			builder.put(grammarAccess.getProcedure_and_function_declaration_partAccess().getAlternatives_0(), "rule__Procedure_and_function_declaration_part__Alternatives_0");
			builder.put(grammarAccess.getAbstraction_declarationAccess().getAlternatives(), "rule__Abstraction_declaration__Alternatives");
			builder.put(grammarAccess.getAbstraction_headingAccess().getAlternatives(), "rule__Abstraction_heading__Alternatives");
			builder.put(grammarAccess.getProcedure_declarationAccess().getAlternatives_2(), "rule__Procedure_declaration__Alternatives_2");
			builder.put(grammarAccess.getFormal_parameter_sectionAccess().getAlternatives(), "rule__Formal_parameter_section__Alternatives");
			builder.put(grammarAccess.getParameter_typeAccess().getAlternatives(), "rule__Parameter_type__Alternatives");
			builder.put(grammarAccess.getConformant_array_schemaAccess().getAlternatives(), "rule__Conformant_array_schema__Alternatives");
			builder.put(grammarAccess.getFunction_declarationAccess().getAlternatives_2(), "rule__Function_declaration__Alternatives_2");
			...
			builder.put(grammarAccess.getRepeat_statementAccess().getGroup(), "rule__Repeat_statement__Group__0");
			builder.put(grammarAccess.getFor_statementAccess().getGroup(), "rule__For_statement__Group__0");
			builder.put(grammarAccess.getIf_statementAccess().getGroup(), "rule__If_statement__Group__0");
			builder.put(grammarAccess.getIf_statementAccess().getGroup_4(), "rule__If_statement__Group_4__0");
			...
			builder.put(grammarAccess.getCase_limbAccess().getGroup(), "rule__Case_limb__Group__0");
			...
			builder.put(grammarAccess.getWith_statementAccess().getGroup(), "rule__With_statement__Group__0");
			builder.put(grammarAccess.getWith_statementAccess().getGroup_2(), "rule__With_statement__Group_2__0");
			builder.put(grammarAccess.getGoto_statementAccess().getGroup(), "rule__Goto_statement__Group__0");
			...
			builder.put(grammarAccess.getArray_typeAccess().getGroup_3(), "rule__Array_type__Group_3__0");
			...
			builder.put(grammarAccess.getSet_typeAccess().getGroup(), "rule__Set_type__Group__0");
			builder.put(grammarAccess.getFile_typeAccess().getGroup(), "rule__File_type__Group__0");
			...
			builder.put(grammarAccess.getPacked_conformant_array_schemaAccess().getGroup(), "rule__Packed_conformant_array_schema__Group__0");
			builder.put(grammarAccess.getBound_specificationAccess().getGroup(), "rule__Bound_specification__Group__0");
			builder.put(grammarAccess.getUnpacked_conformant_array_schemaAccess().getGroup(), "rule__Unpacked_conformant_array_schema__Group__0");
			builder.put(grammarAccess.getUnpacked_conformant_array_schemaAccess().getGroup_3(), "rule__Unpacked_conformant_array_schema__Group_3__0");
			...
			builder.put(grammarAccess.getBlockAccess().getConstantAssignment_1(), "rule__Block__ConstantAssignment_1");
			builder.put(grammarAccess.getBlockAccess().getTypeAssignment_2(), "rule__Block__TypeAssignment_2");
			builder.put(grammarAccess.getBlockAccess().getVariableAssignment_3(), "rule__Block__VariableAssignment_3");
			...
			builder.put(grammarAccess.getSimple_statementAccess().getFunction_noargsAssignment_3(), "rule__Simple_statement__Function_noargsAssignment_3");
			...
			builder.put(grammarAccess.getStructured_statementAccess().getRepetitiveAssignment_1(), "rule__Structured_statement__RepetitiveAssignment_1");
			builder.put(grammarAccess.getStructured_statementAccess().getConditionalAssignment_2(), "rule__Structured_statement__ConditionalAssignment_2");
			builder.put(grammarAccess.getStructured_statementAccess().getWithStmtAssignment_3(), "rule__Structured_statement__WithStmtAssignment_3");
			...
			builder.put(grammarAccess.getRepetitive_statementAccess().getWhileStmtAssignment_0(), "rule__Repetitive_statement__WhileStmtAssignment_0");
			builder.put(grammarAccess.getRepetitive_statementAccess().getRepeatStmtAssignment_1(), "rule__Repetitive_statement__RepeatStmtAssignment_1");
			builder.put(grammarAccess.getRepetitive_statementAccess().getForStmtAssignment_2(), "rule__Repetitive_statement__ForStmtAssignment_2");
			...
			builder.put(grammarAccess.getRepeat_statementAccess().getSequenceAssignment_1(), "rule__Repeat_statement__SequenceAssignment_1");
			builder.put(grammarAccess.getRepeat_statementAccess().getExpressionAssignment_3(), "rule__Repeat_statement__ExpressionAssignment_3");
			builder.put(grammarAccess.getFor_statementAccess().getAssignmentAssignment_1(), "rule__For_statement__AssignmentAssignment_1");
			builder.put(grammarAccess.getFor_statementAccess().getExpressionAssignment_3(), "rule__For_statement__ExpressionAssignment_3");
			builder.put(grammarAccess.getFor_statementAccess().getStatementAssignment_5(), "rule__For_statement__StatementAssignment_5");
			builder.put(grammarAccess.getConditional_statementAccess().getIfStmtAssignment_0(), "rule__Conditional_statement__IfStmtAssignment_0");
			builder.put(grammarAccess.getConditional_statementAccess().getCaseStmtAssignment_1(), "rule__Conditional_statement__CaseStmtAssignment_1");
			builder.put(grammarAccess.getIf_statementAccess().getExpressionAssignment_1(), "rule__If_statement__ExpressionAssignment_1");
			builder.put(grammarAccess.getIf_statementAccess().getIfStatementAssignment_3(), "rule__If_statement__IfStatementAssignment_3");
			builder.put(grammarAccess.getIf_statementAccess().getElseStatementAssignment_4_1(), "rule__If_statement__ElseStatementAssignment_4_1");
			builder.put(grammarAccess.getCase_statementAccess().getExpressionAssignment_1(), "rule__Case_statement__ExpressionAssignment_1");
			builder.put(grammarAccess.getCase_statementAccess().getCasesAssignment_3(), "rule__Case_statement__CasesAssignment_3");
			builder.put(grammarAccess.getCase_statementAccess().getCasesAssignment_4_1(), "rule__Case_statement__CasesAssignment_4_1");
			builder.put(grammarAccess.getCase_limbAccess().getCasesAssignment_0(), "rule__Case_limb__CasesAssignment_0");
			builder.put(grammarAccess.getCase_limbAccess().getStatementAssignment_2(), "rule__Case_limb__StatementAssignment_2");
			...
			builder.put(grammarAccess.getConstantAccess().getNilAssignment_4(), "rule__Constant__NilAssignment_4");
			builder.put(grammarAccess.getWith_statementAccess().getVariablesAssignment_1(), "rule__With_statement__VariablesAssignment_1");
			builder.put(grammarAccess.getWith_statementAccess().getVariablesAssignment_2_1(), "rule__With_statement__VariablesAssignment_2_1");
			builder.put(grammarAccess.getWith_statementAccess().getStatementAssignment_4(), "rule__With_statement__StatementAssignment_4");
			builder.put(grammarAccess.getGoto_statementAccess().getLabelAssignment_1(), "rule__Goto_statement__LabelAssignment_1");
			builder.put(grammarAccess.getLabel_declaration_partAccess().getLabelsAssignment_1(), "rule__Label_declaration_part__LabelsAssignment_1");
			builder.put(grammarAccess.getLabel_declaration_partAccess().getLabelsAssignment_2_1(), "rule__Label_declaration_part__LabelsAssignment_2_1");
			...
			builder.put(grammarAccess.getUnpacked_structured_typeAccess().getArrayAssignment_0(), "rule__Unpacked_structured_type__ArrayAssignment_0");
			...
			builder.put(grammarAccess.getUnpacked_structured_typeAccess().getRecordAssignment_2(), "rule__Unpacked_structured_type__RecordAssignment_2");
			builder.put(grammarAccess.getUnpacked_structured_typeAccess().getSetAssignment_3(), "rule__Unpacked_structured_type__SetAssignment_3");
			builder.put(grammarAccess.getUnpacked_structured_typeAccess().getFileAssignment_4(), "rule__Unpacked_structured_type__FileAssignment_4");
			builder.put(grammarAccess.getArray_typeAccess().getIndexesAssignment_2(), "rule__Array_type__IndexesAssignment_2");
			builder.put(grammarAccess.getArray_typeAccess().getIndexesAssignment_3_1(), "rule__Array_type__IndexesAssignment_3_1");
			builder.put(grammarAccess.getArray_typeAccess().getTypeAssignment_6(), "rule__Array_type__TypeAssignment_6");
			builder.put(grammarAccess.getDynamic_array_typeAccess().getTypeAssignment_2(), "rule__Dynamic_array_type__TypeAssignment_2");
			builder.put(grammarAccess.getIndex_typeAccess().getTypeAssignment(), "rule__Index_type__TypeAssignment");
			...
			builder.put(grammarAccess.getSet_typeAccess().getTypeAssignment_2(), "rule__Set_type__TypeAssignment_2");
			builder.put(grammarAccess.getFile_typeAccess().getTypeAssignment_2(), "rule__File_type__TypeAssignment_2");
			...
			builder.put(grammarAccess.getProcedure_and_function_declaration_partAccess().getProceduresAssignment_0_0(), "rule__Procedure_and_function_declaration_part__ProceduresAssignment_0_0");
			builder.put(grammarAccess.getProcedure_and_function_declaration_partAccess().getFunctionsAssignment_0_1(), "rule__Procedure_and_function_declaration_part__FunctionsAssignment_0_1");
			...
			builder.put(grammarAccess.getProcedure_declarationAccess().getBlockAssignment_2_0(), "rule__Procedure_declaration__BlockAssignment_2_0");
			builder.put(grammarAccess.getProcedure_declarationAccess().getForwardAssignment_2_1(), "rule__Procedure_declaration__ForwardAssignment_2_1");
			...
			builder.put(grammarAccess.getParameter_typeAccess().getArrayAssignment_0(), "rule__Parameter_type__ArrayAssignment_0");
			builder.put(grammarAccess.getParameter_typeAccess().getNameAssignment_1(), "rule__Parameter_type__NameAssignment_1");
			builder.put(grammarAccess.getConformant_array_schemaAccess().getPackedAssignment_0(), "rule__Conformant_array_schema__PackedAssignment_0");
			builder.put(grammarAccess.getConformant_array_schemaAccess().getUnpackedAssignment_1(), "rule__Conformant_array_schema__UnpackedAssignment_1");
			builder.put(grammarAccess.getPacked_conformant_array_schemaAccess().getBoundAssignment_3(), "rule__Packed_conformant_array_schema__BoundAssignment_3");
			builder.put(grammarAccess.getPacked_conformant_array_schemaAccess().getNameAssignment_6(), "rule__Packed_conformant_array_schema__NameAssignment_6");
			builder.put(grammarAccess.getBound_specificationAccess().getInitialAssignment_0(), "rule__Bound_specification__InitialAssignment_0");
			builder.put(grammarAccess.getBound_specificationAccess().getFinalAssignment_2(), "rule__Bound_specification__FinalAssignment_2");
			builder.put(grammarAccess.getBound_specificationAccess().getNameAssignment_4(), "rule__Bound_specification__NameAssignment_4");
			builder.put(grammarAccess.getUnpacked_conformant_array_schemaAccess().getBoundsAssignment_2(), "rule__Unpacked_conformant_array_schema__BoundsAssignment_2");
			builder.put(grammarAccess.getUnpacked_conformant_array_schemaAccess().getBoundsAssignment_3_1(), "rule__Unpacked_conformant_array_schema__BoundsAssignment_3_1");
			builder.put(grammarAccess.getUnpacked_conformant_array_schemaAccess().getTypeAssignment_6(), "rule__Unpacked_conformant_array_schema__TypeAssignment_6");
			builder.put(grammarAccess.getVariable_parameter_sectionAccess().getIdentifiersAssignment_1(), "rule__Variable_parameter_section__IdentifiersAssignment_1");
			...
			builder.put(grammarAccess.getFunction_declarationAccess().getBlockAssignment_2_0(), "rule__Function_declaration__BlockAssignment_2_0");
			builder.put(grammarAccess.getFunction_declarationAccess().getForwardAssignment_2_1(), "rule__Function_declaration__ForwardAssignment_2_1");
		}
	}
